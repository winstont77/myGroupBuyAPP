...
.createGroupBuy-content-form-button-button{
    ...
    margin: auto;
    border-radius: 5px;
    background-image: linear-gradient(105deg, #2e6474, #337192);
}
</style>